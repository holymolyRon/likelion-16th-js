function 물_길러가(양동이_종류) {
  console.log('========Function========')
  console.log(양동이_종류 + '를 챙겨요.')
  console.log('마을 북쪽 우물로 이동해요.')
  console.log('우물에서 물을 길어요!')
  console.log('조심스럽게 양동이를 이고 마을로 들어와요.')
  console.log('========================')
  // 함수 결과 반환(값)
  return 양동이_종류 + '에 길러온 우물의 물';
}

물_길러가('작은 양동이')
물_길러가('큰 양동이')

// '양동이_종류' : 매개변수 (parameter)
// '작은 양동이', '큰 양동이' : 인자 (argument)

const result = 물_길러가('특대 양동이')
console.log(result)
// --------------------------------------------------------------------------
// 실습: 함수 (Function, 기능)
// --------------------------------------------------------------------------
