...
// desk 출력 결과
// console.log(desk) // ReferenceError: desk is not defined
...
// 변수 선언 (생성, 초기화)
// 생성만 한 시점
console.log(notTdz) // undefined 출력 (var는 TDZ 없음)
// console.log(tdz) // ReferenceError 발생 (let/const는 TDZ 존재)

let tdz = '✅ let, const 변수는 "일시적 사각지대(TDZ)" 생성'
